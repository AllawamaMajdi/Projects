...
$sql=" SELECT * FROM bb WHERE catId='1' ";
 ...
 <!-- ======= Header ======= -->
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">Book & Page</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="#">Collections</a>
            <ul>
              <li><a href="Collection.php">Children's books</a></li>
              <li><a href="Collection.php">scientific books</a></li>
			  <li><a href="Collection.php">Novels</a></li>
			  <li><a href="Collection.php">Political books</a></li>
			  <li><a href="Collection.php">Literary books</a></li>
            </ul>
          </li>
